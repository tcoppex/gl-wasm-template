...
var ASM_CONSTS = {
  21842: function() {initialize_custom_cppjs_api()}
};
function my_js_alert(msg){ const s = UTF8ToString(msg); alert(s); console.log('Console log : "' + s + '"'); }
...
/** @type {function(...*):?} */
var _testCall = Module["_testCall"] = createExportWrapper("testCall");

/** @type {function(...*):?} */
var _printNumber = Module["_printNumber"] = createExportWrapper("printNumber");

/** @type {function(...*):?} */
var _square = Module["_square"] = createExportWrapper("square");

/** @type {function(...*):?} */
var _setVerticalSync = Module["_setVerticalSync"] = createExportWrapper("setVerticalSync");

/** @type {function(...*):?} */
var _setBackgroundColor = Module["_setBackgroundColor"] = createExportWrapper("setBackgroundColor");
